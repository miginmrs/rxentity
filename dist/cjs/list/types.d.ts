...
export declare type Entities<T, V extends T> = {
    [k in keyof T]: Entity<T[k], V[k]>;
};
export declare type EntitiesFlow<T, V extends T> = {
    [k in keyof T]: EntityFlow<T[k], V[k]>;
};
export declare type Stores<K extends Pick<any, keyof T>, T, P extends T = never, V extends T = T> = {
    [k in keyof T]: Store<K[k], T[k], P[k], V[k]>;
};
/**
