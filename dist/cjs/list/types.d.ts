...
export declare type Entities<K extends string, KK extends Record<K, string>, T extends TRec<K, KK>, V extends T> = {
    [k in K]: Entity<KK[k], T[k], V[k]>;
};
export declare type EntitiesFlow<K extends string, KK extends Record<K, string>, T extends TRec<K, KK>, V extends T> = {
    [k in K]: EntityFlow<KK[k], T[k], V[k]>;
};
export declare type Stores<K extends string, ID extends Pick<any, K>, KK extends Record<K, string>, T extends TRec<K, KK>, P extends T = never, V extends T = T> = {
    [k in K]: Store<ID[k], KK[k], T[k], P[k], V[k]>;
};
/**
